...
python C:/Users/pol/Desktop/VF/nnv-master/code/nnv/examples/Submission/VNN_COMP2023/execute.py 'run_instance' "$CATEGORY" "$ONNX_FILE" "$VNNLIB_FILE" "$TIMEOUT" "$RESULTS_FILE"
